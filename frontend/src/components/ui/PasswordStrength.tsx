...
export const PasswordStrength: React.FC<PasswordStrengthProps> = ({ password, className }) => {
  ...
  const getStrengthLabel = () => {
    ...
    if (score <= 4) return { text: 'جيدة', color: 'text-light-price dark:text-dark-link', barColor: 'bg-light-price dark:bg-dark-link' };
          ...
          return (
            <li
              ...
              className={cn(
                ...
                met ? 'text-green-600 dark:text-green-400' : 'text-light-secondaryText dark:text-dark-text'
              )}
            >
              <svg
